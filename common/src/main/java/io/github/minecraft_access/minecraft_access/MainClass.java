package io.github.minecraft_access.minecraft_access;

import io.github.minecraft_access.minecraft_access.config.Config;
import io.github.minecraft_access.minecraft_access.config.config_maps.*;
import io.github.minecraft_access.minecraft_access.features.*;
import io.github.minecraft_access.minecraft_access.features.inventory_controls.InventoryControls;
import io.github.minecraft_access.minecraft_access.features.access_menu.AccessMenu;
import io.github.minecraft_access.minecraft_access.features.point_of_interest.POIMarking;
import io.github.minecraft_access.minecraft_access.features.read_crosshair.ReadCrosshair;
import io.github.minecraft_access.minecraft_access.screen_reader.ScreenReaderController;
import io.github.minecraft_access.minecraft_access.screen_reader.ScreenReaderInterface;
    ...
    private static void changeLogLevelBaseOnDebugConfig() {
        ...
        if (debugMode) {
            if (!log.isDebugEnabled()) {
                Configurator.setLevel("io.github.minecraft_access.minecraft_access", Level.DEBUG);
            }
        } else if (log.isDebugEnabled()) {
            Configurator.setLevel("io.github.minecraft_access.minecraft_access", Level.INFO);
        }
    }
