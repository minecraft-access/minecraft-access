...
public class Health implements Status {
    ...
    public @NotNull String message() {
        ...
        if (client.player.getAbsorptionAmount() > 0) {
            return I18n.get(
                    ...
                    NarrationUtils.narrateNumber(client.player.getHealth() / 2.0),
                    NarrationUtils.narrateNumber(client.player.getMaxHealth() / 2.0),
                    NarrationUtils.narrateNumber(client.player.getAbsorptionAmount() / 2.0)
            );
        } else {
            return I18n.get(
    ...
    public @NotNull WarningLevel warning() {
        ...
        assert client.player != null;
        double health = client.player.getHealth() / 2.0;
