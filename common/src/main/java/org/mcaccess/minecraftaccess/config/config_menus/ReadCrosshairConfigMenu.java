...
public class ReadCrosshairConfigMenu extends BaseScreen {
    ...
    protected void init() {
        ...
        Button featureToggleButton = this.buildButtonWidget(featureToggleButtonMessage(initMap.isEnabled()), (button) -> {
        ...
        Button useJadeButton = this.buildButtonWidget(useJadeText.apply(initMap.isUseJade()), (button) -> {
            ReadCrosshairConfigMap map = ReadCrosshairConfigMap.getInstance();
        ...
        Button speakBlockSidesButton = this.buildButtonWidget(speakBlockSidesText.apply(initMap.isSpeakSide()), (button) -> {
            ReadCrosshairConfigMap map = ReadCrosshairConfigMap.getInstance();
        ...
        Button speakAdditionalEntityPosesButton = this.buildButtonWidget(speakAdditionalEntityPosesText.apply(initMap.isSpeakAdditionalEntityPoses()), (button) -> {
            ReadCrosshairConfigMap map = ReadCrosshairConfigMap.getInstance();
        ...
        Button disableConsecutiveBlocksButton = this.buildButtonWidget(disableConsecutiveBlocksText.apply(initMap.isDisableSpeakingConsecutiveBlocks()), (button) -> {
            ReadCrosshairConfigMap map = ReadCrosshairConfigMap.getInstance();
        ...
        ValueEntryMenu.ValueConfig c1 = new ValueEntryMenu.ValueConfig(() -> ReadCrosshairConfigMap.getInstance().getRepeatSpeakingInterval(), (v) -> ReadCrosshairConfigMap.getInstance().setRepeatSpeakingInterval(Integer.parseInt(v)), ValueEntryMenu.ValueType.INT);
        Button repeatSpeakingIntervalButton = this.buildButtonWidget(floatValueButtonMessageWith("minecraft_access.gui.read_crosshair_config_menu.button.repeat_speaking_interval_button", initMap.getRepeatSpeakingInterval()), (button) -> minecraft.setScreen(new ValueEntryMenu(c1, this)), true);
        this.addRenderableWidget(repeatSpeakingIntervalButton);

        Button rcSoundMenuButton = this.buildButtonWidget("minecraft_access.gui.read_crosshair_config_menu.button.relative_position_sound_cue_menu_button", (button) -> this.minecraft.setScreen(new RCRelativePositionSoundCueConfigMenu("relative_position_sound_cue_menu", this)));
        this.addRenderableWidget(rcSoundMenuButton);

        Button rcPartialSpeakingMenuButton = this.buildButtonWidget("minecraft_access.gui.read_crosshair_config_menu.button.partial_speaking_menu_button", (button) -> this.minecraft.setScreen(new RCPartialSpeakingConfigMenu("rc_partial_speaking_menu", this)));
...
class RCPartialSpeakingConfigMenu extends BaseScreen {
    ...
    protected void init() {
        ...
        Button partialSpeakingWhitelistModeButton = this.buildButtonWidget(partialSpeakingWhitelistModeText.apply(initMap.isPartialSpeakingWhitelistMode()), (button) -> {
            RCPartialSpeakingConfigMap map = RCPartialSpeakingConfigMap.getInstance();
        ...
        Button partialSpeakingFuzzyModeButton = this.buildButtonWidget(partialSpeakingFuzzyModeText.apply(initMap.isPartialSpeakingFuzzyMode()), (button) -> {
            RCPartialSpeakingConfigMap map = RCPartialSpeakingConfigMap.getInstance();
...
class RCRelativePositionSoundCueConfigMenu extends BaseScreen {
    ...
    protected void init() {
        ...
        ValueEntryMenu.ValueConfig c1 = new ValueEntryMenu.ValueConfig(() -> RCRelativePositionSoundCueConfigMap.getInstance().getMinSoundVolume(), (v) -> RCRelativePositionSoundCueConfigMap.getInstance().setMinSoundVolume(Float.parseFloat(v)), ValueEntryMenu.ValueType.FLOAT);
        Button minVolumeButton = this.buildButtonWidget(I18n.get("minecraft_access.gui.common.button.min_volume", initMap.getMinSoundVolume()), (button) -> Objects.requireNonNull(minecraft).setScreen(new ValueEntryMenu(c1, this)));
        this.addRenderableWidget(minVolumeButton);

        ValueEntryMenu.ValueConfig c2 = new ValueEntryMenu.ValueConfig(() -> RCRelativePositionSoundCueConfigMap.getInstance().getMaxSoundVolume(), (v) -> RCRelativePositionSoundCueConfigMap.getInstance().setMaxSoundVolume(Float.parseFloat(v)), ValueEntryMenu.ValueType.FLOAT);
        Button maxVolumeButton = this.buildButtonWidget(I18n.get("minecraft_access.gui.common.button.max_volume", initMap.getMaxSoundVolume()), (button) -> Objects.requireNonNull(minecraft).setScreen(new ValueEntryMenu(c2, this)));
