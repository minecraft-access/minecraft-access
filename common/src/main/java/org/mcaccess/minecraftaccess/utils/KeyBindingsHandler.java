...
public class KeyBindingsHandler {
    ...
    public KeyMapping objectTrackerNextItem;
    public KeyMapping objectTrackerPreviousItem;
    public KeyMapping objectTrackerNarrateCurrentObject;
    public KeyMapping targetNearestObject;
