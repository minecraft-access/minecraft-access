...
* [Boat](https://minecraft.wiki/w/Boat), [mine cart](https://minecraft.wiki/w/Minecart), [slime](https://minecraft.wiki/w/Slime), [magma cube](https://minecraft.wiki/w/Magma_cube), and [ancient debris](https://minecraft.wiki/w/Ancient_debris) can be scanned and locked with POI feature now. [#157](https://github.com/minecraft-access/minecraft_access/issues/157) [#203](https://github.com/minecraft-access/minecraft_access/issues/203) [#215](https://github.com/minecraft-access/minecraft_access/issues/215)

### Bug Fixes

* Fix the bug that looking at fluid will make Read Crosshair spam. [#262](https://github.com/minecraft-access/minecraft_access/issues/262)
...
* Fix the bug that locking on Entity will immediately unlock [#248](https://github.com/minecraft-access/minecraft_access/issues/248)
* Fix the bug that mod's INFO log will be logged twice in console and log files [#247](https://github.com/minecraft-access/minecraft_access/issues/247)
* Fix the bug that speaking recipes in Inventory Screen will cause the game crush. [#251](https://github.com/minecraft-access/minecraft_access/issues/251)
...
* Add a new config `Speak Focused Slot Changes` with default `true` value for `Inventory Controls` feature. Close this config if you hear the mod is continuously repeating changes of item name. [#242](https://github.com/minecraft-access/minecraft_access/issues/242)
...
* Now the mod will tell if your [taming operation](https://minecraft.wiki/w/Taming) is successful or not.
