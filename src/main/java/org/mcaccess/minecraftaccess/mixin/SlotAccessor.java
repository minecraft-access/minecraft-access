...
public interface SlotAccessor {
     ...
     * For example, if a slot's index is 0 then it is a hotbar slot if the slot's inventory is of type PlayerInventory
     * while it is the item input slot for furnaces.
